...
import TestComponent from "./components/MediaManager/TestComponent";
      ...
      <main
        className={
          shouldHideSidebar || !isAuthenticated
            ...
            : "flex-grow ml-0 md:ml-64 transition-all duration-300 w-full min-w-0 pt-12 md:pt-0"
        }
      >
        <Routes>
          {/* Public Routes */}
